          ...
          <div className={styles.modalContent}>
            ...
            <div className={styles.contentmodal}>
              <div className={styles.value}>
                {console.log(this.state.detailsListDemande)}
                <div className={styles.accordion}>
                  <div className={`${styles.panel}`}>
                    <p className={styles.value}><b>Demande №:</b> {this.state.detailsListDemande.IdRequestIntranet}</p>
                    <p className={styles.value}><b>Réference ERP de la demande:</b> {this.state.detailsListDemande.RéfRequestERP}</p>
                    <p className={styles.value}><b>Date de création (Intranet):</b> {this.state.detailsListDemande.CreatedDateIntranet}</p>
                    <p className={styles.value}><b>Date d'approbation (Intranet):</b> {this.state.detailsListDemande.DateApprovalIntranet}</p>
                    <p className={styles.value}><b>Réference du dossier achat:</b> {this.state.detailsListDemande.RefDossierAchat}</p>
                    <p className={styles.value}><b>Date dossier achat:</b> {this.state.detailsListDemande.DateDossierAchat}</p>
                    <p className={styles.value}><b>Statut dossier achat: </b>{this.state.detailsListDemande.StatutDossierAchat}</p>
                    <p className={styles.value}><b>Motif d'annulation: </b>{this.state.detailsListDemande.MotifSiAnnuler}</p>
                  </div>
                </div>
              </div>
            </div>
