        ...
        <div id="spListContainer">
          ...
          {currentItems.length > 0 &&
            <table style={{ borderCollapse: "collapse", width: "112%" }}>
              <tr>
                <th colSpan={5} style={{ textAlign: "center", backgroundColor: "#f2f2f2", padding: "8px", border: "1px solid #ddd" }}>Demande Achat</th>
                <th colSpan={4} style={{ textAlign: "center", backgroundColor: "#f2f2f2", padding: "8px", border: "1px solid #ddd" }}>Numéro Dossier Achat</th>
                <th colSpan={3} style={{ textAlign: "center", backgroundColor: "#f2f2f2", padding: "8px", border: "1px solid #ddd" }}>Commande</th>
              </tr>
              <tr>
