          ...
          {currentItems.length > 0 &&
            <table style={{ borderCollapse: "collapse", width: "112%" }}>
              <tr>
                ...
                <th colSpan={4} style={{ textAlign: "center", backgroundColor: "#7d2935", padding: "8px", border: "1px solid #ddd" }}>Dossier Achat</th>
              ...
              {currentItems.length > 0 &&
                currentItems.map((demande: any, index: any) =>
                  <tr>
                    ...
                    <td>{demande.StatutDossierAchat}</td>
                    <td>
                      {demande.MotifSiAnnuler.length === 0 ? <>***</> : demande.MotifSiAnnuler}
                    </td>
