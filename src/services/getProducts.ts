...
export async function getProduct(idSubFamily, ResponceCenter, BudgetName) {
    try {
        ...
        const response = await fetch(GET_PRODUCTS, {
            ...
            body: JSON.stringify({ "IdSubFamily": idSubFamily, "RespCenter": ResponceCenter, BudgetName: BudgetName })
        });
