...
export default class DashboardConsultationDemandesWebPart extends BaseClientSideWebPart<IDashboardConsultationDemandesWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IDashboardConsultationDemandesProps> = React.createElement(
      DashboardConsultationDemandes,
      {
